...
const { email, password, name, picture, role, location, phoneNumber, weight, info } = schema.tree
...
router.post('/',
  master(),
  body({ email, password, name, picture, role, location, phoneNumber, weight, info }),
  create)
...
router.put('/:id',
  token({ required: true }),
  body({ name, picture, location, phoneNumber, weight, info }),
  update)
